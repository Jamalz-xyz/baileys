# WhatsApp Web API - Modified by VarShade

<p align="center">
  <strong>✨ Enhanced Baileys Library ✨</strong><br>
  <em>Modified by <a href="https://github.com/FarXyz-ID">VarShade (Fardan)</a></em><br><br>
  📞 <strong>Support Contact:</strong> <code>083151785747</code> (Baileys-related only)
</p>

<p align="center">
  <a href="https://www.npmjs.com/package/@varshade/baileys-lite"><img src="https://img.shields.io/npm/v/@varshade/baileys-lite?color=blue&label=npm" alt="NPM Version"></a>
  <a href="https://github.com/FarXyz-ID/baileys"><img src="https://img.shields.io/github/stars/FarXyz-ID/varshade?style=social" alt="GitHub Stars"></a>
</p>
...
This is a customized fork of **Baileys**, a WebSockets-based TypeScript library for WhatsApp Web API, enhanced with more features and stability improvements.

```javascript
const { default: makeWASocket } = require("@varshade/baileys-lite")
```
...
> This project is NOT affiliated with WhatsApp Inc. WhatsApp® and all related trademarks are property of Meta Platforms, Inc.
...
- ❌ Stalkerware
- ❌ Any abuse violating WhatsApp ToS
...
**👨‍💻 Developer Profile**
  ...
  <img src="https://github-readme-stats.vercel.app/api?username=FarXyz-ID&show_icons=true&theme=radical&hide_border=true" alt="GitHub Stats">
</p>

</p><p align="center">
  <img src="https://github-readme-stats.vercel.app/api?username=J-Forces&show_icons=true&theme=radical&hide_border=true" alt="GitHub Stats">
</p>
---
...
```bash
npm install @varshade/baileys-lite
```

**🧪 Latest Version Development**

```bash
yarn add @varshade/baileys-lite@latest
```
...
```bash
git clone https://github.com/FarXyz-ID/baileys.git
cd baileys
npm install
...
- ✔️ Enhanced connection stability
- ✔️ Additional utility methods
- ✔️ Optimized event handling
- ✔️ Custom patches and fixes
...
Refer to the original Baileys docs for core features. Mod-specific additions will be in the wiki.

---

📌 Need help? Open an issue or contact the number above!
...
```javascript
const makeWASocket = require("@varshade/baileys-lite").default;
const { useMultiFileAuthState } = require("@varshade/baileys-lite");
...
```javascript
const makeWASocket = require("@varshade/baileys-lite").default;
const { DisconnectReason, useMultiFileAuthState } = require("@varshade/baileys-lite");
   ...
   message: {
       ...
       interactiveMessage: proto.Message.InteractiveMessage.create({
         ...
         footer: proto.Message.InteractiveMessage.Footer.create({
           text: "I don't know because this will be your text"
         }),
...
const { downloadMediaMessage, getContentType } = require("@varshade/baileys-lite");
...
> [!NOTE]
> Also, this repo is now licenced under GPL 3 since it uses [libsignal-node](https://git.questbook.io/backend/service-coderunner/-/merge_requests/1) and is available at [VShade GitHub](https://github.com/FarXyz-ID).

---

**Need help with this modified version? Contact VShade at 083151785747**