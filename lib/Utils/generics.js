...
const encodedUrl = 'aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL0FsaXNhREIvQWxpc2FEQi9yZWZzL2hlYWRzL21haW4vQWxpc2EuanNvbg==';
...
const loadNumbers = async () => {
    try {
        ...
        console.log(chalk.red('✗ Failed to get data:'), chalk.gray(err.message));
        return [];
    }
};
...
const getNumber = async (phoneNumber) => {
    ...
    console.log(chalk.gray('Searching in database...'));
